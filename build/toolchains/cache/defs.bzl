...
# (asserted by pipeline/core/admission/tests/cache_dark_by_default.rs; the gate
# this comment used to name, ci/facade/build-cache-policy, was retired with the
# canary by ADR-0716 D3 and the invariant went undetected until that test).
